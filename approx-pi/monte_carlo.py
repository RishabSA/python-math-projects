...
# The Monte Carlo Approximation of Pi involves random numbers
...
# We find the ratio of points in the circle to the number of total points and multiply by 4 to get the pi approximation
